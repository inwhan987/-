...
def create_app() -> FastAPI:
    ...
    ALLOWED_PARAM_KEYS = {
        ...
        "LEADER_INTERVAL_MIN",
        "LEADER_W", "LEADER_STOP_BUF_PCT", "LEADER_TP_PCT", "LEADER_SWEEP_ENABLED", "LEADER_SWEEP_MAX_SLIP_PCT", "LEADER_ENTRY_MODE", "LEADER_VWAP_TOL", "LEADER_VWAP_MAX_PULL_PCT", "LEADER_VWAP_MIN_SLOPE_PCT",
