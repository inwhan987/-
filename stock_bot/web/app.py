...
def create_app() -> FastAPI:
    ...
    def dashboard(request: Request):
        ...
        cfg = {
            ...
            "swing_entry_min_score": settings.swing_entry_min_score,
    ...
    ALLOWED_PARAM_KEYS = {
        ...
        "LEADER_INTERVAL_MIN",
        "LEADER_W", "LEADER_STOP_BUF_PCT", "LEADER_TP_PCT", "LEADER_ENTRY_MARKET_RETRY",
        "LEADER_ENTRY_YIELD_LOCK", "LEADER_ENTRY_BLOCK_SEC", "LEADER_SELL_BLOCK_SEC", "LEADER_ENTRY_MODE", "LEADER_VWAP_TOL", "LEADER_VWAP_MAX_PULL_PCT", "LEADER_VWAP_MIN_SLOPE_PCT",
        ...
        "SWING_ENTRY_MIN_SCORE", "SWING_ENTRY_MIN_RAW_BY_STRATEGY",
        "SWING_ENTRY_BATCH_SEC", "SWING_FILL_BLOCK_SEC",
