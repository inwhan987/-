...
_HOT_FIELDS = (
    ...
    ("LEADER_SWEEP_ENABLED", "leader_sweep_enabled", lambda v: v.lower() in ("1", "true", "yes", "on")),
    ("LEADER_SWEEP_MAX_SLIP_PCT", "leader_sweep_max_slip_pct", float),
...
_LEADER_KEYS = frozenset({
    ...
    "LEADER_SWEEP_ENABLED", "LEADER_SWEEP_MAX_SLIP_PCT",
