...
def create_app() -> FastAPI:
    ...
    ALLOWED_PARAM_KEYS = {
        ...
        "LEADER_ANCHOR_TOL", "LEADER_VOLFILTER", "LEADER_FIB_DYNAMIC", "LEADER_RECLAIM", "LEADER_TOP3_RATIO",
        "LEADER_SWITCH_ENABLED", "LEADER_SWITCH_INTERVAL_MIN", "LEADER_SWITCH_UNTIL",
        "LEADER_SWITCH_MOVE_MAX_PCT", "LEADER_SECTOR_SWITCH_THRESHOLD", "LEADER_MAX_SECTORS",
        "LEADER_SLOT_V2", "LEADER_SECTOR_5PCT", "LEADER_STOCK_5PCT",
        ...
        "LEADER_SEL_MIN_VALUE_EOK", "LEADER_SEL_DYN_VALUE_PCT", "LEADER_SEL_SECTOR_TOP3", "LEADER_SEL_MIN_CAP_EOK", "LEADER_SEL_MAX_CHANGE",
        "LEADER_MF_WINDOW_SHORT", "LEADER_MF_WINDOW_LONG", "LEADER_MF_CLAMP_LOW", "LEADER_MF_CLAMP_HIGH",
        "STOCK_CAPITAL_KRW", "LEADER_CAPITAL_KRW", "INITIAL_CAPITAL_KRW",
        "LEAD_ST_W_VALUE", "LEAD_ST_W_FLOW", "LEAD_ST_W_UPDN", "LEAD_ST_W_TURNOVER", "LEAD_ST_W_SURGE",
        "LEAD_ST_NF_W_VALUE", "LEAD_ST_NF_W_UPDN", "LEAD_ST_NF_W_TURNOVER", "LEAD_ST_NF_W_SURGE",
