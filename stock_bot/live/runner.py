...
_HOT_FIELDS = (
    ...
    ("NEWS_CRAWL_INTERVAL_MINUTES", "news_crawl_interval_minutes", int),
    ("NEWS_MIN_ARTICLES", "news_min_articles", int),
    ("NEWS_BUY_THRESHOLD", "news_buy_threshold", float),
    ("NEWS_SELL_THRESHOLD", "news_sell_threshold", float),
    ("NEWS_RELEVANCE_FILTER", "news_relevance_filter", lambda v: v.lower() in ("1", "true", "yes", "on")),
    ("ENSEMBLE_USE_NEWS", "ensemble_use_news", lambda v: v.lower() in ("1", "true", "yes", "on")),
    ...
    ("ENSEMBLE_EMA_TREND_FAST", "ensemble_ema_trend_fast", int),
    ("ENSEMBLE_EMA_TREND_SLOW", "ensemble_ema_trend_slow", int),
    ...
    ("LEADER_SLOT_BUDGET_KRW", "leader_slot_budget_krw", float),
    ...
    ("LEADER_ENTRY_MARKET_RETRY", "leader_entry_market_retry", int),
    ("LEADER_ENTRY_YIELD_LOCK", "leader_entry_yield_lock",
     lambda v: v.lower() in ("1", "true", "yes", "on")),
    ("LEADER_ENTRY_BLOCK_SEC", "leader_entry_block_sec", float),
    ("LEADER_SELL_BLOCK_SEC", "leader_sell_block_sec", float),
    ("LEADER_EXIT_MODE", "leader_exit_mode", str),
    ("LEADER_TRAIL_ACTIVATE_PCT", "leader_trail_activate_pct", float),
    ("LEADER_TRAIL_GAP_PCT", "leader_trail_gap_pct", float),
    ("LEADER_SPLIT_TP1_PCT", "leader_split_tp1_pct", float),
    ("LEADER_SPLIT_TP1_RATIO", "leader_split_tp1_ratio", float),
    ("LEADER_SPLIT_TP2_PCT", "leader_split_tp2_pct", float),
    ...
    ("LEADER_FIB_DYNAMIC", "leader_fib_dynamic", lambda v: v.lower() in ("1", "true", "yes", "on")),
    ...
    ("LEADER_SEL_MIN_VALUE_ANCHOR_HHMM", "leader_sel_min_value_anchor_hhmm", str),
    ("LEADER_SEL_MAX_VALUE_EOK", "leader_sel_max_value_eok", float),
    ("LEADER_SEL_MIN_VALUE_FLOOR_EOK", "leader_sel_min_value_floor_eok", float),
    ("LEADER_SEL_MIN_CAP_EOK", "leader_sel_min_cap_eok", float),
    ("LEADER_SEL_MAX_CHANGE", "leader_sel_max_change", float),
    ("LEADER_SEL_TURNOVER_CAP_PCT",    "leader_sel_turnover_cap_pct",    float),
    ...
    ("SWING_WATCH_POOL", "swing_watch_pool", int),
    ("SWING_AXIS_MIN_EACH", "swing_axis_min_each", float),
    ("SWING_PSCORE_MIN_N", "swing_pscore_min_n", int),
    ("SWING_PSCORE_POOL_DAYS", "swing_pscore_pool_days", int),
    ...
    ("SWING_NORMAL_CONFIRM_BARS", "swing_normal_confirm_bars", int),
    ("SWING_NORMAL_MAX_RATIO", "swing_normal_max_ratio", float),
    ("SWING_FILL_BLOCK_SEC", "swing_fill_block_sec", float),
...
_LEADER_KEYS = frozenset({
    "LEADER_TRADE_ENABLED", "LEADER_BUDGET_KRW", "LEADER_MAX_POSITIONS", "LEADER_SLOT_BUDGET_KRW",
    "LEADER_INTERVAL_MIN",
    "LEADER_W", "LEADER_STOP_BUF_PCT", "LEADER_TP_PCT",
    "LEADER_ENTRY_MARKET_RETRY", "LEADER_ENTRY_YIELD_LOCK", "LEADER_ENTRY_BLOCK_SEC",
    "LEADER_SELL_BLOCK_SEC",
    ...
    "LEADER_SEL_VOL_MULT", "LEADER_SEL_MIN_VALUE_EOK",
    "LEADER_SEL_MIN_VALUE_ANCHOR_HHMM", "LEADER_SEL_MAX_VALUE_EOK", "LEADER_SEL_MIN_VALUE_FLOOR_EOK",
    "LEADER_SEL_MIN_CAP_EOK",
